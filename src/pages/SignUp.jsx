  ...
  useEffect(() => {
    ...
    if (actualPlan == "trial") {
      setCreateApp((prev) => {
        return {
          ...prev,
          plan: actualPlan ? actualPlan : "trial",
          pay: false,
          price: "0",
        };
      });
      ...
      <div className="card-visa-container">
        <div className="front">
          ...
          <div className="card-number-box">
            {createApp.card_number ? createApp.card_number : "################"}
          </div>
          <div className="flexbox">
            <div className="box">
              <span>card holder</span>
              <div className="card-holder-name">
                {createApp.card_holder ? createApp.card_holder : "full name"}
              </div>
            </div>
            <div className="box">
              <span>expires</span>
              <div className="expiration">
                <span className="exp-month">
                  {createApp.month ? createApp.month : "mm"}
                </span>
                <span className="exp-year">
                  {createApp.year_input ? createApp.year_input : "yy"}
                </span>
              </div>
            </div>
          </div>
      ...
      <form className="payment-form" onSubmit={BuyTokenVisa}>
        <div className="inputBox">
          ...
          <input
            type="text"
            maxlength="16"
            value={createApp.card_number}
            onChange={(e) =>
              setCreateApp({ ...createApp, card_number: e.target.value })
            }
        ...
        <div className="inputBox">
          ...
          <input
            type="text"
            name="card_holder"
            value={createApp.card_holder}
            onChange={(e) =>
              setCreateApp({ ...createApp, card_holder: e.target.value })
            }
        ...
        <div className="flexbox">
          <div className="inputBox">
            ...
            <select
              name="month"
              value={createApp.month}
              onChange={(e) =>
                setCreateApp({ ...createApp, month: e.target.value })
              }
          ...
          <div className="inputBox">
            ...
            <select
              name="year_input"
              value={createApp.year_input}
              onChange={(e) =>
                setCreateApp({ ...createApp, year_input: e.target.value })
              }
              id=""
          ...
          <div className="inputBox">
            ...
            <input
              type="text"
              maxlength="4"
              value={createApp.cvv_value}
              onMouseEnter={updateVisa}
              onChange={(e) =>
                setCreateApp({ ...createApp, cvv_value: e.target.value })
              }
              className="cvv-input"
            />
          </div>
              ...
              <div className="single-signup" style={{ width: "55%" }}>
                ...
                <div className="sign-content">
                  <p className="message-register">
                    Create Your App / {plan} / USD {createApp?.price}
                  </p>
                </div>
                <form id="contacts-form" onSubmit={createAppSent}>
                  ...
                  <div style={{ display: "flex", flexDirection: "row" }}>
                    ...
                    <input
                      ...
                      value={createApp.name}
                      type="text"
                      placeholder="company name"
                    />{" "}
                    <span>.riskcurb.com</span>
                  </div>
                  <label>Email</label>
                  <input
                    type="text"
                    onChange={handleChange}
                    value={createApp.email}
                    name="email"
                    placeholder="email"
                  />
                  ...
                  {createApp?.pay && <>{visa_form}</>}
                  <div className="register-button floatright">
                    <button className="btn btn-success">
                      Create Risk Management App
                    </button>
                  </div>
                </form>
                <p id="nav">
